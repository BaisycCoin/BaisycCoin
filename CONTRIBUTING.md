Contributing to BaisycCoin Core
============================

The BaisycCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BaisycCoin Core project, and is not to be
confused with overall BaisycCoin Network Protocol consensus changes.

Whether a pull request is merged into BaisycCoin Core rests with the project merge
...
Patches that change BaisycCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the BaisycCoin consensus, it must have been
...
The project leader is the release manager for each BaisycCoin Core release.
