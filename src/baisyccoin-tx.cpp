...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Baisyccoin Core baisyccoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  baisyccoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded baisyccoin transaction") + "\n" +
                               "  baisyccoin-tx [options] -create [commands]   " + _("Create hex-encoded baisyccoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded baisyccoin transaction
