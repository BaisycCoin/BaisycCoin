...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BaisycCoin Core"),
     ...
     * override -datadir in the baisyccoin.conf file in the default data directory
     * (to be consistent with baisyccoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
