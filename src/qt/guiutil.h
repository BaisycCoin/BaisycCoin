...
/** Utility functions used by the BaisycCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render BaisycCoin addresses in monospace font
...
// Parse "baisyccoin:" URI into recipient object, return true on successful parsing
