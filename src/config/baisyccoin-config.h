/* src/config/baisyccoin-config.h.  Generated from baisyccoin-config.h.in by configure.  */
/* src/config/baisyccoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BSYC_CONFIG_H

#define BSYC_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.baisyccoin.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Baisyccoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Baisyccoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "baisyccoin"
