...
It is recommended [use the shell script](https://github.com/BaisycCoin/bsycInstall) to install a BaisycCoin Masternode on a Linux server running Ubuntu 16.04, 18.04
