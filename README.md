Baysic-Coin Core Integration Repository
======================================


It is recommended [use the shell script](https://github.com/Baysic-Coin/lpcinstall) to install a LightPayCoin Masternode on a Linux server running Ubuntu 14.04 or 16.04
