...
This mechanism has been integrated into Bitcore-Node-BaisycCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/BaisycCoin-Project/insight-api-baisyccoin#web-socket-api](https://github.com/BaisycCoin-Project/insight-api-baisyccoin#web-socket-api) 
* API: [https://github.com/BaisycCoin-Project/insight-api-baisyccoin#swifttx-transactions](https://github.com/BaisycCoin-Project/insight-api-baisyccoin#swifttx-transactions) 
...
By default, the BaisycCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BaisycCoin Core daemon:
