...
In order to support loading of multiple wallets in baisyccoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is baisyccoin.cpp.
...
Changes to baisyccoin.cpp
----------------------
baisyccoin.cpp is the entry point into baisyccoin-qt, and as such, will require some minor modifications to provide hooks for
